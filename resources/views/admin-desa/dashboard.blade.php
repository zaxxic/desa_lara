  ...
  <body>
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link collapse" href="dashboard.html">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed show" href="profile-desa.html">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="data-penduduk.html">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="peraturan.html">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="penghargaan.html">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="sarana-umum.html">
            <span
                                id="boot-icon"
                                class="bi bi-globe"

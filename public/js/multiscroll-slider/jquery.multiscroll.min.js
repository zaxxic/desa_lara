...
b(".ms-left .ms-section.active").index();a=a.index();return c>a?"up":"down"}function A(){var a=b(".ms-left .ms-section.active"),f=a.data("anchor"),a=a.index(),a=String(a);c.anchors.length&&(a=f);a=a.replace("https://kodesolution.com/","-").replace("#","");f=RegExp("\\b\\s?ms-viewing-[^\\s]+\\b","g");b("body")[0].className=b("body")[0].className.replace(f,"");b("body").addClass("ms-viewing-"+a)}function J(){var a=e.createElement("p"),b,c={webkitTransform:"-webkit-transform",OTransform:"-o-transform",msTransform:"-ms-transform",
